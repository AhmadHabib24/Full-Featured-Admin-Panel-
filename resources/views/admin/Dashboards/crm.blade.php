                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('dashboard.crm')}}">CRM</a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-2">
                                    <div class="d-flex align-items-start">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-2.jpg')}}"
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-3.jpg')}}"
                                            width="40" alt="Generic placeholder image">
                                        <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-4.jpg')}}"
                                            width="40" alt="Generic placeholder image">
                                        <div class="w-100 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-5.jpg')}}"
                                            width="40" alt="Generic placeholder image">
                                        <div class="w-100 overflow-hidden">
                                            <span class="badge badge-warning-lighten float-end">Cold lead</span>
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-1.jpg')}}"
                                            width="40" alt="Generic placeholder image">
                                        <div class="w-100 overflow-hidden">
                                            <span class="badge badge-warning-lighten float-end">Cold lead</span>
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/avatar-6.jpg')}}"
                                            width="40" alt="Generic placeholder image">
                                        <div class="w-100 overflow-hidden">
                                            <span class="badge badge-success-lighten float-end">Won lead</span>
                            ...
                            <div class="card cta-box bg-primary text-white">
                                <div class="card-body">
                                    <div class="d-flex align-items-start align-items-center">
                                        <div class="w-100 overflow-hidden">
                                            <h2 class="mt-0 text-reset"><i class="mdi mdi-bullhorn-outline"></i>&nbsp;
                                            </h2>
                                            <h3 class="m-0 fw-normal cta-box-title text-reset">Enhance your <b>Campaign</b>
                                                for better outreach <i class="mdi mdi-arrow-right"></i></h3>
                                        </div>
                                        <img class="ms-3" src="{{asset('assets/images/svg/email-campaign.svg')}}" width="120"
